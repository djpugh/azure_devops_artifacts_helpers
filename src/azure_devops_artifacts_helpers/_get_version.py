def get_version() -> str:
    ...
    if version == '0+unknown':
        ...
        if sys.version_info.major >= 3 and sys.version_info.minor >= 8:
            from importlib.metadata import version as parse_version, PackageNotFoundError
        else:
            from importlib_metadata import version as parse_version, PackageNotFoundError  # type: ignore
        try:
            version = parse_version("azure_devops_artifacts_helpers")
